...
-- indicator
INSERT INTO gobs.indicator (id, id_label, id_title, id_description, id_date_format, id_value_code, id_value_name, id_value_type, id_value_unit, id_paths) VALUES (1, 'pluviometry', 'Daily pluviometry ', 'Daily rainfall pluviometry in millimetre', 'day', '{pluviometry}', '{Pluviometry}', 'integer', 'mm', 'Environment / Water / Data | Physical and chemical conditions / Water ');
INSERT INTO gobs.indicator (id, id_label, id_title, id_description, id_date_format, id_value_code, id_value_name, id_value_type, id_value_unit, id_paths) VALUES (2, 'subdistrict_population', 'Subdistrict population ', 'Number of inhabitants for each subdistrict', 'year', '{population}', '{Population}', 'integer', 'people', 'Socio-eco / Demography / Population ');
...
Material : ...');
INSERT INTO gobs.protocol (id, pr_code, pr_name, pr_description) VALUES (2, 'cirad-population', 'Population', 'Number of inhabitants obtained from census forms.');
...
INSERT INTO gobs.spatial_layer (id, sl_code, sl_label, sl_description, sl_creation_date, fk_id_actor, sl_geometry_type) VALUES (3, 'montpellier-sub-districts', 'Montpellier Sub-districts', 'Sub-districts of Montpellier, France', '2019-07-15', 2, 'multipolygon');

-- series
INSERT INTO gobs.series (id, fk_id_protocol, fk_id_actor, fk_id_indicator, fk_id_spatial_layer) VALUES (1, 1, 2, 1, 1);
INSERT INTO gobs.series (id, fk_id_protocol, fk_id_actor, fk_id_indicator, fk_id_spatial_layer) VALUES (2, 2, 2, 2, 3);
