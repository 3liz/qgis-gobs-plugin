-- TABLES
-- actor_category
INSERT INTO gobs.actor_category (id, ac_name, ac_description) VALUES
...
(id, a_name, a_description, a_email, id_category)
VALUES
(1, 'IGN', 'French national geographical institute.', 'contact@ign.fr', 1),
(2, 'CIRAD', 'The French agricultural research and international cooperation organization', 'contact@cirad.fr', 2),
...
(id, id_label, id_title, id_description, id_date_format, id_value_code, id_value_name, id_value_type, id_value_unit, id_paths)
VALUES
...
(id, pr_code, pr_name, pr_description)
VALUES
